 ...
 * @since 1.1
 */
public class SimpleFilenameUtils {
    ...
    public static boolean directoryContains(final String canonicalParent, final String canonicalChild)
        ...
        if (SimpleIOCase.SYSTEM.checkEquals(canonicalParent, canonicalChild)) {
            return false;
        }

        return SimpleIOCase.SYSTEM.checkStartsWith(canonicalChild, canonicalParent);
    }
     ...
     * @see SimpleIOCase#SENSITIVE
     */
    public static boolean equals(final String filename1, final String filename2) {
        return equals(filename1, filename2, false, SimpleIOCase.SENSITIVE);
    }
     ...
     * @param filename2  the second filename to query, may be null
     * @return true if the filenames are equal, null equals null
     * @see SimpleIOCase#SYSTEM
     */
    public static boolean equalsOnSystem(final String filename1, final String filename2) {
        return equals(filename1, filename2, false, SimpleIOCase.SYSTEM);
    }
    ...
    public static boolean equalsNormalized(final String filename1, final String filename2) {
        return equals(filename1, filename2, true, SimpleIOCase.SENSITIVE);
    }
    ...
    public static boolean equalsNormalizedOnSystem(final String filename1, final String filename2) {
        return equals(filename1, filename2, true, SimpleIOCase.SYSTEM);
    }
    ...
    public static boolean equals(
            ...
            final boolean normalized, SimpleIOCase caseSensitivity) {
        ...
        if (caseSensitivity == null) {
            caseSensitivity = SimpleIOCase.SENSITIVE;
        }
    ...
    public static boolean wildcardMatch(final String filename, final String wildcardMatcher) {
        return wildcardMatch(filename, wildcardMatcher, SimpleIOCase.SENSITIVE);
    }
    ...
    public static boolean wildcardMatchOnSystem(final String filename, final String wildcardMatcher) {
        return wildcardMatch(filename, wildcardMatcher, SimpleIOCase.SYSTEM);
    }
     ...
     * @since 1.3
     */
    public static boolean wildcardMatch(final String filename, final String wildcardMatcher, SimpleIOCase caseSensitivity) {
